...
from testvpc import priv_nets_ids, testopensearch_sg
...
domain = aws.opensearch.Domain(
    ...
    #     #     aws.opensearch.DomainAutoTuneOptionsMaintenanceScheduleArgs(
    #     #         cron_expression_for_recurrence="string",
    #     #         duration=aws.opensearch.DomainAutoTuneOptionsMaintenanceScheduleDurationArgs(
    #     #             unit="string",
    #     #             value=0,
    #     #         ),
    #     #         start_at="string",
    ...
    vpc_options=aws.opensearch.DomainVpcOptionsArgs(
        ...
        security_group_ids=[testopensearch_sg.id],
    ),
